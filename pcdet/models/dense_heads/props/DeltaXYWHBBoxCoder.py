...
class DeltaXYWHBBoxCoder(BaseBBoxCoder):
    ...
    def __init__(self,dictionary:dict,
                 **kwargs) -> None:
        target_means=dictionary['target_means']
        target_stds=dictionary['target_stds']
        clip_border=True if not 'clip_border' in dictionary else dictionary['clip_border']
        add_ctr_clamp=False if not 'add_ctr_clamp' in dictionary else dictionary['add_ctr_clamp']
        ctr_clamp=32 if not 'ctr_clamp' in dictionary else dictionary['ctr_clamp']
